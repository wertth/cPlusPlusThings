...
#ifndef CPLUSPLUSTHINGS_LARGE_FILE_WORD_FRE_CPP
#define CPLUSPLUSTHINGS_LARGE_FILE_WORD_FRE_CPP
...
: buckets_(nbuckets)
        {
                ...
                assert(buckets_.size() == static_cast<int>(nbuckets));
        }
...
#endif //CPLUSPLUSTHINGS_LARGE_FILE_WORD_FRE_CPP
